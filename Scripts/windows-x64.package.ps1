...
$publish_directory="..\src\Obsidian.OxD\bin\$configuration\netcoreapp2.2\$runtime\publish"
...
& $warp --arch windows-x64 --input_dir $publish_directory --exec Obsidian.OxD.exe --output $publish_directory\oxd-$git_commit.exe
