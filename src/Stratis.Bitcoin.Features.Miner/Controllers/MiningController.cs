    ...
    public class MiningController : Controller
    {
        ...
        public IActionResult Generate([FromBody]MiningRequest request)
        {
            ...
            try
            {
                ...
                {
                    Blocks = this.powMining.GenerateBlocks(new ReserveScript(new BitcoinWitPubKeyAddress(address.Bech32Address, this.network).ScriptPubKey), (ulong)blockCount, int.MaxValue)
                };
