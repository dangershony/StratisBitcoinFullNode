...
namespace Stratis.Bitcoin.Features.Consensus.Rules.CommonRules
{
    ...
    public class BlockHeaderRule : ConsensusRule
    {
        ...
        public override Task RunAsync(RuleContext context)
        {
            ...
            if (context.BlockValidationContext.PowBlock.Header.HashPrevBlock != context.ConsensusTip.HashBlock)
            {
            ...
            context.BlockValidationContext.ChainedBlock = new ChainedBlock(context.BlockValidationContext.PowBlock.Header, 
                context.BlockValidationContext.PowBlock.Header.GetHash(NetworkOptions.TemporaryOptions), 
