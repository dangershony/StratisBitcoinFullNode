...
export class StatusBarComponent implements OnInit, OnDestroy {
  ...
  private getSecretInfo() {
    let walletInfo = new WalletInfo(this.globalService.getWalletName());
    this.apiService.makeRequest(new RequestObject("generalInfo", walletInfo), this.onGetSecretInfo.bind(this));
  }
  private onGetSecretInfo(responsePayload: ResponsePayload) {
